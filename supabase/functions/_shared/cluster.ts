...
- skipped 에 넣을 것
  · 광고, 홍보, 협찬, 부고, 인사, 동정, 운세, 날씨 안내
  · 개별 종목·환율·유가 시황, 부동산 시세표 같은 반복 수치 기사
  · 특정 지역의 단순 행사·축제·캠페인 안내
  · 기업의 신제품 출시, 실적 발표 같은 개별 홍보성 소식
  · 연예인 사생활, 스포츠 개별 경기 결과, 방송 프로그램 예고
  · 칼럼, 사설, 인터뷰, 기획 연재물처럼 새 사건이 없는 글
  · 이미 지나간 일을 정리하거나 되짚는 기사
